...
const Missao = () => {
  return (
    <section className="flex flex-col items-center justify-center bg-gradient-to-r from-[#1e1e28] to-[#2e2e3e] text-white py-20 px-6 md:px-16" id="missao">
      
      {/* TÍTULO PRINCIPAL DA SEÇÃO */}
      <h1 className="text-4xl md:text-5xl font-extrabold text-center text-white mb-16">Nossa Missão</h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl">
        ...
        <div className="w-full md:w-1/2 mb-10 md:mb-0 md:mr-8">
          <img
            ...
            alt="Imagem Missão"
            className="w-full max-w-md mx-auto rounded-2xl shadow-[0_0_25px_rgba(128,90,213,0.3)] object-cover"
          />
        </div>
